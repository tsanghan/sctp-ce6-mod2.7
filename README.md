...
sctp-ce6-mod2.7sctp-ce6-mod2.7 on 🌱 main [📝🤷‍] via 💠 default
λ while : ; do echo "testing..." ; nc -z -w5 $PUBLIC_DNS 80; if [[ $? == '0' ]]; then echo 'Port 80 up!!!' ; break; fi ; sleep 5; donwhile :do echo "testing..."ncif [[== '0' ]]then echo 'Port 80 up!!!'breakfisleepdonewhile : ; do echo "testing..." ; nc -z -w5 $PUBLIC_DNS 80; if [[ $? == '0' ]]; then echo 'Port 80 up!!!' ; break; fi ; sleep 5; donewhile : ; do echo "testing..." ; nc -z -w5 $PUBLIC_DNS 80; if [[ $? == '0' ]]; then echo 'Port 80 up!!!' ; break; fi ; sleep 5; donewhile :do echo "testing..."ncif [[== '0' ]]then echo 'Port 80 up!!!'breakfisleepdone
whiletesting...
testing...
testing...
testing...
